...
const storeMaster = () => {
  ...
  return (
    <Container className={styles.vehicle}>
      ...
      <Row>
        <Col>
          <button onClick={togglePopover} id="submit" type='button' style={{ marginLeft: '20px' }}>
            <CgAddR style={{ fontSize: '27px', marginTop: '-2px', marginRight: '5px' }} /> Add Category</button>
          {isPopoverOpen && (
              ...
              <Form onSubmit={handleSubmit}>
                <Row className='mb-3'>
                  <FormGroup as={Col} md="6" controlId="validationCustom03">
                    <FormLabel value={formData.category} onChange={handleChange} required>Category Name</FormLabel>
                    <FormControl
                      required
                      type="text"
                    />
                ...
                <Button type="submit" id="submit" onSubmit={handleSubmit}>Add Category</Button>
              </Form>
            </div>
          )}
        </Col>
      ...
      <Row>
        <Col>
          <h2 style={{ marginLeft: '23px', marginTop: '15px', marginBottom: '25px', fontSize: '22px' }}>Stock Item Category</h2>
